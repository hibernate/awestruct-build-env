...
```
docker run --rm=true -t -i -p 4242:4242 --security-opt label:disable -v website-gems:/home/dev/.gem -v $(pwd):/home/dev/website quay.io/hibernate/awestruct-build-env:latest rake setup clean gen[staging]
```
